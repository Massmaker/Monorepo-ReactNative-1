...
import { TabRouterOptions } from '@react-navigation/routers';
...
declare const _default: <ParamList extends Record<string, object | undefined>>() => import("../../../native/src").TypedNavigator<ParamList, BottomTabNavigationOptions, typeof BottomTabNavigator>;
