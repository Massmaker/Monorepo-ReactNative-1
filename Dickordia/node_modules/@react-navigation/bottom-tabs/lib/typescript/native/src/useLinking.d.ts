...
export default function useLinking(ref: React.RefObject<NavigationContainerRef>, { prefixes, config, getStateFromPath }: Options): {
    getInitialState: () => Promise<(Partial<Pick<import("../../core/src").NavigationState, "index">> & {
        stale?: true | undefined;
        type?: string | undefined;
        routes: (Pick<import("../../core/src").Route<string>, "name" | "params"> & {
            key?: string | undefined;
            state?: import("../../core/src").InitialState | undefined;
        })[];
    } & {
        state?: (Partial<Pick<import("../../core/src").NavigationState, "index">> & {
            stale?: true | undefined;
            type?: string | undefined;
            routes: (Pick<import("../../core/src").Route<string>, "name" | "params"> & {
                key?: string | undefined;
